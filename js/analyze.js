        ...
        reader.onload = (e) => {
            try {
                ...
                const fieldMap = {
                    ...
                    'money customers owe you (ar)': 'receivables',
                    ...
                    'money owed to suppliers (ap)': 'payables',
                    'payables': 'payables',
                    'ap': 'payables',
                ...
                const ytdFieldMap = {
                    ...
                    'owner drawings / dividends': 'ytdOwnerDrawings',
                    'asset purchases': 'ytdAssetPurchases',
                    'equipment / asset purchases': 'ytdAssetPurchases',
                ...
                const prevFieldMap = {
                    ...
                    'net profit': 'netProfit', 'net profit / (loss)': 'netProfit', 'net income': 'netProfit',
                    'cash in bank': 'cash', 'cash': 'cash', 'bank balance': 'cash',
                    'accounts receivable': 'receivables', 'accounts receivable (ar)': 'receivables', 'money customers owe you (ar)': 'receivables', 'receivables': 'receivables',
                    'inventory': 'inventory', 'inventory / stock on hand': 'inventory',
                    'accounts payable': 'payables', 'accounts payable (ap)': 'payables', 'money owed to suppliers (ap)': 'payables', 'payables': 'payables'
                };
